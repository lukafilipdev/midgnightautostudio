...
export default function Home() {
  ...
  return (
    <main className="bg-black text-white min-h-screen overflow-x-hidden">
      <nav className="fixed top-0 left-0 w-full bg-black/70 backdrop-blur-xl z-[70] border-b border-neutral-900">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-5 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="#booking"
              className="w-[140px] py-2.5 rounded-full text-xs tracking-[0.15em] font-semibold text-center bg-white text-black transition-all duration-300 hover:bg-transparent hover:text-white border-2 border-white"
            >
              {t("book")}
            </a>
          </div>
      ...
      <section className="relative min-h-[100svh] flex items-center justify-center px-6 pt-24">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/65 via-black/40 to-black pointer-events-none" />
        </div>
        <div
          className="relative z-20 max-w-4xl text-center pointer-events-auto"
          data-reveal
        >
          ...
          <div className="max-w-xl mx-auto space-y-3">
            <p className="text-white/90 text-base md:text-lg font-light tracking-wide">
              ...
              <span className="font-medium"> BMW M</span>,
              <span className="font-medium"> Audi RS</span> {lang === "sl" ? "in" : lang === "de" ? "und" : "&"}
              <span className="font-medium"> Porsche</span>.
            </p>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              href="#booking"
              className="w-full sm:w-auto px-10 py-3 rounded-full text-xs tracking-[0.2em] font-semibold text-center bg-white text-black transition-all duration-300 hover:bg-transparent hover:text-white border border-white"
            >
              {t("request")}
            </a>
            <a
              href="#projects"
              className="w-full sm:w-auto px-10 py-3 rounded-full text-xs tracking-[0.2em] font-medium text-center text-gray-300 transition-all duration-300 hover:text-white border border-neutral-700 hover:border-white"
            >
              {t("viewBuilds")}
            </a>
          </div>
