...
export function MaterialsSection({ kicker, title, subtitle, partnersLabel, brands }: MaterialsSectionProps) {
              ...
              >
                <div className="material-card-inner">
                  <p className={`font-semibold tracking-[0.04em] ${
                    brand.name.length > 10 ? "text-base md:text-lg" : "text-lg md:text-xl"
                  }`}>
                    {brand.name}
                  </p>
                  <p className="text-[11px] md:text-xs text-white/50 mt-1.5 tracking-wide">
                    {brand.descriptor}
                  </p>
                </div>
              </div>
